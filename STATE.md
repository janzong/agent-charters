...
> 最后更新：2026-09-15（数据集 **v0.5** / 规则集 **`ruleset_v0.1.9`**；**100 份人工核对已全部闭环**，
...
唯一的测量方法）③~~跨文件类型一致性检测（同一仓库 `AGENTS.md` 与 `CLAUDE.md` 是否互相矛盾）~~ → ❌ **2026-09-15 实测不成立**：真冲突仅 2.5%（`LIMITATIONS.md` §25）；同一次测量改推的替代项是「**指针识别 / 跟随**」
