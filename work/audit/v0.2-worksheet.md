...
```
- 完整原文：`data/raw/full/google__adk-python.md`（本页只摘前 600 字）
- 判定：□ 准确　□ 漏标（缺哪类：______）　□ 错标（多哪类：______）　备注：
...
```
- 完整原文：`data/raw/full/humeo__code-helm.md`（本页只摘前 600 字）
- 判定：□ 准确　□ 漏标（缺哪类：______）　□ 错标（多哪类：______）　备注：
...
```
- 完整原文：`data/raw/full/koala73__worldmonitor.md`（本页只摘前 600 字）
- 判定：□ 准确　□ 漏标（缺哪类：______）　□ 错标（多哪类：______）　备注：
...
```
- 完整原文：`data/raw/full/mercurialsolo__claudectl.md`（本页只摘前 600 字）
- 判定：□ 准确　□ 漏标（缺哪类：______）　□ 错标（多哪类：______）　备注：
...
```
- 完整原文：`data/raw/full/open-mercato__cezar.md`（本页只摘前 600 字）
- 判定：□ 准确　□ 漏标（缺哪类：______）　□ 错标（多哪类：______）　备注：
...
```
- 完整原文：`data/raw/full/sooperset__mcp-atlassian.md`（本页只摘前 600 字）
- 判定：□ 准确　□ 漏标（缺哪类：______）　□ 错标（多哪类：______）　备注：
...
```
- 完整原文：`data/raw/full/streamlit__streamlit.md`（本页只摘前 600 字）
- 判定：□ 准确　□ 漏标（缺哪类：______）　□ 错标（多哪类：______）　备注：
...
```
- 完整原文：`data/raw/full/zgsm-ai__costrict.md`（本页只摘前 600 字）
- 判定：□ 准确　□ 漏标（缺哪类：______）　□ 错标（多哪类：______）　备注：
...
```
- 完整原文：`data/raw/full/Smith42__astroPT.md`（本页只摘前 600 字）
- 判定：□ 准确　□ 漏标（缺哪类：______）　□ 错标（多哪类：______）　备注：
...
```
- 完整原文：`data/raw/full/ag-grid__ag-charts.md`（本页只摘前 600 字）
- 判定：□ 准确　□ 漏标（缺哪类：______）　□ 错标（多哪类：______）　备注：
...
```
- 完整原文：`data/raw/full/jantimon__web-performance-debugger.md`（本页只摘前 600 字）
- 判定：□ 准确　□ 漏标（缺哪类：______）　□ 错标（多哪类：______）　备注：
...
## 
```
- 完整原文：`data/raw/full/moKshagna-p__musico.md`（本页只摘前 600 字）
- 判定：□ 准确　□ 漏标（缺哪类：______）　□ 错标（多哪类：______）　备注：
...
Route every 
```
- 完整原文：`data/raw/full/peteromallet__Arnold.md`（本页只摘前 600 字）
- 判定：□ 准确　□ 漏标（缺哪类：______）　□ 错标（多哪类：______）　备注：
