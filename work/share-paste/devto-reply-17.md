# dev.to 回复 · nomad-link-id（2026-09-22 拟，待人粘贴）
...
| 仪表轨最新 | 175 个真实任务；47 个在带章程仓；173 条适用规则；3 条违规 = **98.3%**；任务级违规 2/175；平均返工 **0.26** 轮 |
...
The non-random operational track has grown, but it still cannot answer the counterfactual: 175 real tasks, 47 in repos with a charter, 173 applicable written rules, and 3 violations, or 98.3% rule-level compliance; 2/175 tasks had a violation and average rework was 0.26 rounds. Assignment is not randomized and the covered-rule denominator is thin, so I read that as observability and prioritization data, not as proof the charter changed decisions.
